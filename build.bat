...
ebook-convert "%inputFile%" "../%outputFile%" -v --paper-size=a4 --breadth-first --level1-toc=//h:h1 --level2-toc=//h:h2 --level3-toc=//h:h3 --authors="ม๗นโ" --pdf-page-margin-left=18 --pdf-page-margin-right=18 --pdf-header-template=%header_tpl% --pdf-footer-template=%header_tpl%
cd ..